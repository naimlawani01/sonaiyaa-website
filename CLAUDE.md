...
- `img/`: Site visuals (e.g., phone mockups).

## Specific Rules
- **Performance & Lightweight**: Do not introduce heavy external libraries like jQuery, React, Bootstrap, or Tailwind.
- **Brand Consistency**: Maintain the organic design (blurred gradient shapes) and the "premium" aesthetic. Use the `Plus Jakarta Sans` font and the orange accent color `#FF5A1F`.
